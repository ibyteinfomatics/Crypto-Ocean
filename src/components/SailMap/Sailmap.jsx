...
function Sailmap(){
    ...
    useEffect(() => {
        $(".sailmap--wrapper").scroll(function() { 
            let windowTop = $(".sailmap--wrapper").scrollTop();
            let totalHeight = $(".sailmap--wrapper")[0].scrollHeight+500;
            $(".icon--ship").each(function() {
                let width = $(".sailmap--wrapper").width(); 
                // device detection
                ...
                let totalHeight = $(".sailmap--wrapper")[0].scrollHeight-620;

                let percentage = (moveForward * 100) / totalHeight;
